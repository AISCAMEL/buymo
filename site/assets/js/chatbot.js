...
(function () {
  ...
  var GAS  = 'https://script.google.com/macros/s/AKfycbxO8sl8moAF6lFwliBm-0JQAdJcv17TAcw_gq2KOt-2fPkLqsh1wP3CZE2NJKT62lVBsw/exec';
    ...
    user: {
      ...
      rules: [
        ...
        { k: ['エリア','地域','出張','全国','対応地域','どこ'],
          a: '**全国47都道府県に対応**。お近くの提携業者がオンラインで査定に伺います。離島も対応可能です。',
        ...
        // オンライン査定の流れ・所要時間
        { k: ['オンライン査定','来てもらう','自宅','当日','所要','時間どれくらい','どのくらいかかる','立ち会い','立会'],
          a: '**オンライン査定は最短即日〜数日で調整**。当日は車両確認で**30分〜1時間ほど**です。ご自宅・職場・駐車場どこでもOK。査定額はその場、または後日メールでご提示します。',
          cta: [CTA_FORM] },
