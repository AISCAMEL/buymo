...
const COPY = {
  ...
  harrier: {
    points: ['トヨタ ハリアーはリセールが高く相場より高価買取', 'ガソリン・ハイブリッド・ターボいずれも高評価', '過走行・年式が古くても人気で値が付きやすい', '事故歴・修復歴ありでもまずはご相談を'],
    faq: [
      ['ハリアーは高く売れますか？', 'はい。ハリアーは国内人気が高くリセールバリューも高いため、年式が経過しても高値が付きやすい車種です。'],
      ['ハイブリッドとガソリン、どちらが高いですか？', 'どちらも需要がありますが、ハイブリッド・ターボや上位グレードは高査定になりやすい傾向です。装備・カラーも評価します。'],
      ['過走行のハリアーでも買い取れますか？', 'はい。人気車種のため過走行でも需要があり、しっかり査定します。'],
      ['事故歴があっても対象ですか？', 'はい。修復歴車も専門ルートで買取可能です。現状のままご相談ください。'],
    ],
  },
  velfire: {
    points: ['ヴェルファイアは高級ミニバンとして高需要・高価買取', 'エグゼクティブ/Zグレード・サンルーフ等の装備を高評価', '過走行・年式が古くても値崩れしにくい', '事故歴・修復歴ありでも専門ルートで買取'],
    faq: [
      ['ヴェルファイアはアルファードより安くなりますか？', 'いいえ。ヴェルファイアも非常に人気が高く、グレードや装備次第でアルファードに劣らない高価買取が可能です。'],
      ['どんなグレードが高く売れますか？', 'エグゼクティブラウンジ・Zグレードや、サンルーフ・後席モニター等の装備付きは高査定になりやすいです。'],
      ['過走行でも大丈夫ですか？', 'はい。ヴェルファイアは需要が高く、走行距離が多くてもしっかり査定します。'],
      ['ローンが残っていても売れますか？', 'はい。残債ありでも買取・精算までサポートします。'],
    ],
  },
  noahvoxy: {
    points: ['ノア・ヴォクシーは定番ミニバンで中古需要が安定', 'ハイブリッド・4WD・両側電動スライド等を高評価', '過走行・年式が古くてもファミリー需要で値が付く', '事故歴・修復歴ありでもまずはご相談を'],
    faq: [
      ['ノアとヴォクシーは査定額が違いますか？', 'どちらも人気が高く安定した査定が可能です。グレード・装備・状態に応じて評価します。'],
      ['ハイブリッドは高く売れますか？', 'はい。ハイブリッド・4WD・両側電動スライドドア付きは需要が高く、高査定になりやすいです。'],
      ['過走行のミニバンでも買い取れますか？', 'はい。ファミリー需要が高く、走行距離が多くてもしっかり査定します。'],
      ['旧型（80系など）でも対象ですか？', 'はい。旧型も中古需要があり買取可能です。現状のままご相談ください。'],
    ],
  },
  nbox: {
    points: ['N-BOXは軽の販売台数トップで中古需要が非常に高い', 'カスタム・ターボ・両側電動スライド等を高評価', '過走行・年式が古くても安定した買取価格', '事故歴・修復歴ありでもまずはご相談を'],
    faq: [
      ['N-BOXは高く売れますか？', 'はい。N-BOXは新車販売でも人気トップクラスで中古需要が非常に高く、安定して高価買取が可能です。'],
      ['カスタムやターボは有利ですか？', 'はい。カスタム・ターボ・両側電動スライドドア等の人気装備は高査定につながりやすいです。'],
      ['台数が多い車種ですが安く買われませんか？', '需要も非常に多いため、相場に基づき適正・高価に査定します。ご安心ください。'],
      ['過走行でも買い取れますか？', 'はい。実用需要が高く、走行距離が多くてもしっかり査定します。'],
    ],
  },
  camper: {
    points: ['キャブコン・バンコン・軽キャンパーまで幅広く高価買取', 'ソーラー・サブバッテリー・FFヒーター等の架装設備もプラス評価', '過走行・年式が古くても実用需要が高く値が付きやすい', 'ビルダー架装車・自作キャンピングカーもまずはご相談を'],
    faq: [
      ['キャンピングカーは高く売れますか？', 'はい。キャンピングカーは新車価格が高く中古需要も安定しているため、年式が古くても高値が付きやすい車種です。架装内容によってはさらにプラス評価になります。'],
      ['軽キャンパーやバンコンも対象ですか？', 'はい。キャブコン・バンコン・軽キャンパー・トレーラーまで幅広く対応します。ベース車を問わず査定します。'],
      ['後付けの設備は評価されますか？', 'ソーラーパネル・サブバッテリー・FFヒーター・シンク・ベッドキットなどの設備は需要につながり、加点評価できる場合があります。'],
      ['過走行のキャンピングカーでも買い取れますか？', 'はい。キャンピングカーは実用需要が高く、走行距離が多くてもしっかり査定します。事故歴・修復歴ありでもご相談ください。'],
    ],
  },
  wheel: {
...
const CATCH = {
  ...
  harrier:     'ハリアーは、乗るほど価値が続く。',
  velfire:     'ヴェルファイアの押し出しを、価格に。',
  noahvoxy:    '家族の定番を、しっかり高く。',
  nbox:        '売れ筋のN-BOXは、確実に高く。',
  kei:         '人気の軽は、高く回る。',
  suv:         'SUV人気を、そのまま価格に。',
...
const EXAMPLES = {
  ...
  harrier:     [['トヨタ ハリアー ハイブリッド', '2020年式', '¥3,200,000'], ['トヨタ ハリアー ガソリン', '2018年式', '¥2,350,000'], ['トヨタ ハリアー（旧型）', '過走行', '¥980,000']],
  velfire:     [['ヴェルファイア 2.5Z', '2019年式', '¥3,600,000'], ['ヴェルファイア エグゼクティブ', '上級グレード', '¥4,500,000'], ['ヴェルファイア（旧型）', '過走行', '¥1,650,000']],
  noahvoxy:    [['ヴォクシー ハイブリッド', '2020年式', '¥2,650,000'], ['ノア Si', '2018年式', '¥1,780,000'], ['ヴォクシー（80系）', '過走行', '¥950,000']],
  nbox:        [['ホンダ N-BOX カスタム', '2020年式', '¥1,320,000'], ['ホンダ N-BOX G', '2019年式', '¥1,080,000'], ['ホンダ N-BOX（旧型）', '過走行', '¥620,000']],
  ...
  camper:      [['トヨタ カムロード（キャブコン）', 'バンテック架装', '¥3,800,000'], ['ハイエース バンコン', '低走行・自走式', '¥2,900,000'], ['軽キャンパー', '過走行・現状', '¥680,000']],
